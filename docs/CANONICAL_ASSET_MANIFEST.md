...
| Vercel `amm-phase9-owned-demand-assets-20260821` | CLI-created unlinked-worktree helper `prj_v8534MJYV5xUCp3pYqxWsmZJPifK`; zero deployments and no domain effect | **ARCHIVE AFTER REVIEW** | Worktree is relinked to the canonical project; preserve helper until separately approved cleanup |

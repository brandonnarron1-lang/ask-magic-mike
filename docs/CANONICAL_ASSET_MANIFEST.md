...
| PR #238 / `codex/phase9-cumulative-release-20260829` | Exact payload `9232641329acb8a02ce4cf2419cb12768ce33d17`; linear PR #210–#243 history plus one hash-pinned, backup-first five-migration cutover | **CANONICAL** | Single current application candidate; use only the exact cumulative gate in `CURRENT_RELEASE_AUTHORITY.md` |

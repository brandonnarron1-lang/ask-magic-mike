...
| PR #238 / `codex/phase9-cumulative-release-20260829` | Exact payload `fd4f12c2438964f9fac08e63eba457f8ef3d1d84`; linear PR #210–#243 history plus one hash-pinned, backup-first five-migration cutover | **CANONICAL** | Single current application candidate; use only the exact cumulative gate in `CURRENT_RELEASE_AUTHORITY.md` |

...
| Draft PR #247 / `codex/owned-demand-readiness-main-20260901` | Clean current-main port of the exact WordPress placement-readiness decision logic | **MERGE INTO CANONICAL** | Unsealed review only; no active gate, migration, WordPress mutation, or external action |

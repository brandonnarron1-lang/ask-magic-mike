...
- **Historical acceptance:** refreshed code-bearing head
...
- **Parent refresh:** former PR #216 head
  ...
  `rescue/amm-pr216-pre-pr215-exact-seal-20260828-231335`. Exact sealed PR #215
  `c53cec6043525b593b254c457efdbbe5a29c0520` merged with every product
  application file intact; conflicts were limited to additive changelog/QA
  records and the executable release-authority test. PR #216's stronger shared

...
LCP/INP/CLS. It writes no lead/session/attribution identity and the protected
Growth read model calculates bounded, metric-ID-deduplicated P75 evidence by
mobile and desktop. Preview renders no reporter and performs no telemetry write.

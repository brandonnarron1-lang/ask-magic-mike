...
If necessary, reinstall the preserved 1.1.0 package, but do not automatically
restore the legacy pre-consent GTM head/noscript bootstrap. Do not change the
Form 3 bridge flag/allowlist or delete WordPress/Neon records. Ask rollback is
to remove

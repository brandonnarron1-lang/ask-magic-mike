...
| ---: | --- | --- | --- | --- | --- | --- | --- |
| 1 | Contact Us | name, email, phone, subject, message, CAPTCHA | general question | Blocked | Active | No native Consent field | Add approved unselected requested-response and optional-marketing consent; then map and QA |
...
| 6 | Short Term Home Rentals | name, phone, email, details, CAPTCHA | rental inquiry | Blocked | Active | No native Consent field | Add approved unselected consent; then map details and QA |

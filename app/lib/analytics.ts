...
export function trackEvent(
  ...
  // The consented browser event remains useful for the approved GTM boundary,
  // while this small server ledger gives the lead pipe an auditable event
  // without sending PII.
  ...
  if (!isBrowserAutomation() && !isCanonicalLedgerProtectedEvent(event)) {

  ...
  return (
    <PublicInfoPage
      ...
      sections={[
        ...
        { title: "Optional public analytics", body: <p>Google Analytics is off on AskMagicMike.com until you choose Allow analytics. If allowed, the approved Our Town Properties tag may use first-party analytics storage and a cross-domain linker to understand a public journey between the two sites. Advertising storage, advertising user data, and ad personalization remain denied. Internal QA, Preview, private Lead Center, phone setup, and embedded-widget contexts are excluded. You can change this device&apos;s choice through Analytics preferences in the footer.</p> },

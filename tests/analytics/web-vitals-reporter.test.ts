...
describe("privacy-minimized Web Vitals contract", () => {
  ...
  it("replaces the durable metric identifier with a domain-separated digest", () => {
    expect(webVitalMetricDigest("v5-1787346000000-123456789")).toBe(
      "wv1_55470c37b9b6e86d4755e4a48a2390b39df2ffb2499f54af7f14cd9c7160a278",
    );
    expect(webVitalMetricDigest("v5-other")).not.toBe(webVitalMetricDigest("v5-1787346000000-123456789"));
  });

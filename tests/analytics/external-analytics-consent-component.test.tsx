...
const navigation = vi.hoisted(() => ({ pathname: "/home-value", search: "" }));
...
describe("ExternalAnalyticsConsentManager", () => {
  ...
  it("removes a loaded runtime when only the query changes to internal QA", async () => {
    window.localStorage.setItem(EXTERNAL_ANALYTICS_CONSENT_STORAGE_KEY, "granted");

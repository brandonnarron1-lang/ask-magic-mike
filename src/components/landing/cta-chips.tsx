...
const CHIPS: CTAChipConfig[] = [
  {
    ...
    icon: Home,
    variant: "gold",
    defaultQuestion: "What is my home worth right now in Wilson, NC?",
  },
  {
    id: "should_sell_now",
    ...
    icon: TrendingUp,
    variant: "gold",
    defaultQuestion: "Is now a good time to sell my home in Wilson, NC?",
  },
  {
    id: "tour_home",
    ...
    icon: CalendarCheck,
    variant: "gold",
    defaultQuestion: "I'd like to tour some homes for sale in Wilson or Eastern NC. Can you help?",
  },
  {
    id: "what_can_afford",
    ...
    icon: DollarSign,
    variant: "gold",
    defaultQuestion: "What price range can I realistically afford in Wilson, NC?",
  },
  {
    id: "talk_to_mike",
    label: "Talk to Mike",
    icon: Phone,
    variant: "ruby",
    defaultQuestion: "I'd like to talk directly with Mike Eatmon.",
  },
];

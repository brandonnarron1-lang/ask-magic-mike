              ...
              <div className="md:col-span-2 relative min-h-80 md:min-h-full">
                ...
                <div className="absolute bottom-5 left-5">
                  <div className="bg-glass-gold rounded-xl px-4 py-3 border border-gold-400/25 inline-flex items-center gap-2.5">
                    ...
                    />
                    <div>
                      <div className="text-xs font-bold tracking-[0.12em] uppercase text-gold-400 leading-none">Our Town</div>
                ...
                <div className="flex items-center gap-4">
                  <button
                    ...
                    className={cn(
                      ...
                      "hover:bg-gold-300 active:scale-[0.97] motion-reduce:active:scale-100 transition-all duration-200 motion-reduce:transition-none group",
                  ...
                  <a href="tel:2522454337"
                    className="inline-flex items-center gap-2 rounded-xl border border-gold-400/25 px-6 py-3.5 text-sm font-medium text-gold-300 hover:bg-gold-400/[0.08] hover:border-gold-400/45 transition-all"
                  >
